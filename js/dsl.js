// this is essentially just the JS embedded directly in Rust code in tree-sitter
// that gets piped to Node
// This is needed if a JS DSL file is used as the source of the grammar,
// but not if you already have the JSON grammar file generated by this
...
function field(name, rule) {
  if (typeof name !== "string" || !/^[a-zA-Z_][a-zA-Z0-9_]*$/.test(name)) {
    throw new Error(
      `Invalid field name '${name}': field names must start with a letter or underscore, followed by letters, digits, or underscores`,
    );
  }
  return {
    type: "FIELD",
